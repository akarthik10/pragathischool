...
--
-- Host: localhost
-- Generation Time: Jan 07, 2014 at 09:27 AM
...
--
-- Table structure for table `employee_electives`
--

CREATE TABLE IF NOT EXISTS `employee_electives` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `employee_id` int(11) DEFAULT NULL,
  `elective_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
