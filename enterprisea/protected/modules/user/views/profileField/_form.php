...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="m_row varname">
		...
		<p class="m_hint"><?php echo UserModule::t("Allowed lowercase letters and digits."); ?></p>
	</div>

	<div class="m_row title">
		<?php echo CHtml::activeLabelEx($model,'title'); ?>
		<?php echo CHtml::activeTextField($model,'title',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo CHtml::error($model,'title'); ?>
		<p class="m_hint"><?php echo UserModule::t('Field name on the language of "sourceLanguage".'); ?></p>
	</div>

	<div class="m_row field_type">
		...
		<p class="m_hint"><?php echo UserModule::t('Field type column in the database.'); ?></p>
	</div>

	<div class="m_row field_size">
		...
		<p class="m_hint"><?php echo UserModule::t('Field size column in the database.'); ?></p>
	</div>

	<div class="m_row field_size_min">
		...
		<p class="m_hint"><?php echo UserModule::t('The minimum value of the field (form validator).'); ?></p>
	</div>

	<div class="m_row required">
		...
		<p class="m_hint"><?php echo UserModule::t('Required field (form validator).'); ?></p>
	</div>

	<div class="m_row match">
		...
		<p class="m_hint"><?php echo UserModule::t("Regular expression (example: '/^[A-Za-z0-9\s,]+$/u')."); ?></p>
	</div>

	<div class="m_row range">
		...
		<p class="m_hint"><?php echo UserModule::t('Predefined values (example: 1;2;3;4;5 or 1==One;2==Two;3==Three;4==Four;5==Five).'); ?></p>
	</div>

	<div class="m_row error_message">
		...
		<p class="m_hint"><?php echo UserModule::t('Error message when you validate the form.'); ?></p>
	</div>

	<div class="m_row other_validator">
		...
		<p class="m_hint"><?php echo UserModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('file'=>array('types'=>'jpg, gif, png'))))); ?></p>
	</div>

	<div class="m_row default">
		...
		<p class="m_hint"><?php echo UserModule::t('The value of the default field (database).'); ?></p>
	</div>

	<div class="m_row widget">
		...
		<p class="m_hint"><?php echo UserModule::t('Widget name.'); ?></p>
	</div>

	<div class="m_row widgetparams">
		...
		<p class="m_hint"><?php echo UserModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('param1'=>array('val1','val2'),'param2'=>array('k1'=>'v1','k2'=>'v2'))))); ?></p>
	</div>

	<div class="m_row position">
		...
		<p class="m_hint"><?php echo UserModule::t('Display order of fields.'); ?></p>
	</div>

	<div class="m_row visible">
	...
	<div class="m_row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? UserModule::t('Create') : UserModule::t('Save'),array('class'=>'m_btn')); ?>
	</div>
