 ...
 */
class CenterLocation extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('center_id, name, business_format, registration_no, tax_no, vat_no, is_new, opertaing_from, center_tutors_no, students_no, comp_literate, ms_level, computer_no, is_connected, isp, internet_type, internet_speed, is_capped, is_cam, is_headset, is_multifunction, is_projector, is_board', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'is_cam' => 'Cam',
			'is_headset' => 'Headset',
			'is_multifunction' => 'Multifunction',
