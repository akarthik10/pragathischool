 ...
 */
class EnrollmentBatches extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		if(Yii::app()->controller->id == 'academicYears')
		{
			return array(
				...
				array('id, name, course_id, academic_yr_id, start_date, end_date, is_active, is_deleted, employee_id', 'safe', 'on'=>'search'),
			);
		}
		else
		{
	...
	public function attributeLabels()
	{
		return array(
			...
			'academic_yr_id' => 'Academic Year ID',
			'start_date' => Yii::t('Batch','Start Date'),
			'end_date' => Yii::t('Batch','End Date'),
			'is_active' => 'Is Active',
			'is_deleted' => 'Is Deleted',
			'employee_id' => Yii::t('Batch','Class Teacher'),
		);
	}
