...
<div class="panel panel-default">
  ...
  <?php $documents = CenterImages::model()->findAllByAttributes(array('center_id'=>$_REQUEST['id'])); ?>
    <?php
			...
			?>
				...
				<?php echo CHtml::link('Edit', array('centerImages/update','id'=>$document->center_id,'document_id'=>$document->id),array('class'=>''));  ?></span>
                <span class="btn btn-danger">
				<i class="glyphicon glyphicon-trash"></i>
				<?php echo CHtml::link('Delete', array('centerImages/deletes','id'=>$document->center_id,'document_id'=>$document->id),array('class'=>'','confirm'=>'Are you sure?'));  ?></span>
                </div>
                </div>
    <?php }}else{ ?>
...
<div class="panel-footer">
      <?php echo CHtml::Link('Continue',array('center/view','id'=>$_REQUEST['id']),array('class'=>'btn btn-orange')); ?>
     </div>
<!-- form -->
