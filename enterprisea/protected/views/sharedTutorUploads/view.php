<div class="pageheader">
  ...
  <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a href="index.html">Shared Tutor</a></li>
  ...
  <div class="col-sm-9 col-lg-12">
    <div class="panel panel-default">
        ...
        <li ><?php echo CHtml::Link('<strong>Tutor <br>Details</strong>',array('sharedTutor/view','id'=>$id));?></li>
          ...
          <li class="active"><?php echo CHtml::Link('<strong>Upload <br>Documents</strong>',array('sharedTutorUploads/view','id'=>$id));?></li>
           <li ><?php echo CHtml::Link('<strong>Upload <br>Images</strong>',array('sharedTutorImages/view','id'=>$id));?></li>
        </ul>
      <div class="panel-heading" style="position:relative; height:60px;">
        <div class="btn-demo file_up" style="position:relative; top:-8px; right:3px; float:right;"><?php echo CHtml::Link('Edit Upload Documents',array('sharedTutorUploads/create','id'=>$id),array('class'=>'btn btn-success'));?></div>
