...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'action'=>CController::createUrl('centerUploads/update',array('document_id'=>$model->id))
)); ?>
<div class="panel panel-default">
	<div class="panel-heading" style="position:relative;">
        ...
        <div class="col-sm-4">
        	 <?php echo CHtml::link('Document List', array('centerUploads/create', 'id'=>$center_id),array('class'=>' btn btn-success pull-right')); ?>
        </div>
                ...
                <tr>
                    ...
                    <td id="existing_file">
                        ...
                        <div class="btn-demo" style="margin:10px 10px 5px;">
                        	 <?php echo CHtml::link('<span>'.Yii::t('students','View').'</span>', array('centerUploads/download','id'=>$model->id,'center_id'=>$model->center_id),array('class'=>'btn btn-primary')); ?>
