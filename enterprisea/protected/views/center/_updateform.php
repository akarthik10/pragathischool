...
<div class="panel-heading">
		...
		<?php echo $form->error($model,'dob'); ?>
            ...
            <div class="row mb10">
            	<div class="col-sm-4">
                <div class="form-group">
                     	<label class="control-label">Fully Bilingual?</label><br />
                ...
                <div class="form-group">
						...
						<?php echo $form->radioButtonList($model, 'gender', array('M'=>'Male', 'F'=>'Female'), array('uncheckValue'=>null, 'onclick'=>"",'labelOptions'=>array('style'=>'display:inline'),'separator'=>' &nbsp;&nbsp;')); ?>
                        <?php echo $form->error($model,'gender'); ?>
                  </div>
                </div>
                <div class="col-sm-4">
                <div class="form-group">
                     	<label class="control-label">Preferred Language</label><br />
            ...
            <div class="row mb10">
                ...
                <div class="form-group">
                        ...
                        ));//,'options' => array('164'=>array('selected'=>true)) ?>
          ...
          <div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title">Product & Services</h4>
  </div>
  <div class="panel-body">
    <div class="row mb10">
      <div class="col-sm-6">
       
        <p>Default Product & Services</p>
        <ul style="list-style:none;">
        
        <?php 
			$i = 1;
			$defaults = Services::model()->findAllByAttributes(array('is_editable'=>0));
			foreach($defaults as $default){
				echo '<li>'.$i.'. '.$default->name.'</li>';
				$i++;
			} ?>
      ...
      <div class="col-sm-4">
        <div class="form-group">
          <label class="control-label">Select Product & Services</label>
         <?php 
				$options = array();
				$services	= CHtml::listData(Services::model()->findAllByAttributes(array('is_editable'=>1)), 'id', 'name' );
				if(isset($_POST['Services']['service_id']))
				{
					 foreach ($_POST['Services']['service_id'] as $optionVal) {
						 if ($optionVal) {
							$options[$optionVal] = array('selected' => 'selected');
							}
						}
				}else
					$saved_courses= ServiceCenter::model()->findAllByAttributes(array('center_id'=>$model->id));
				if(isset($saved_courses))
				{
					 foreach ($saved_courses as $optionVal) {
						 if ($optionVal) {
							$options[$optionVal->service_id] = array('selected' => 'selected');
							}
						}
				}
				echo $form->dropDownList($model_service,'service_id',$services,array('options' =>$options,'multiple'=>true,'class'=>'form-control mb15')); //,'prompt' => 'Select Course Category'?>
          <?php echo $form->error($model_service,'service_id'); ?> </div>
      </div>
      <div class="col-sm-4"></div>
      <div class="col-sm-4"></div>
    </div>
...
<div class="panel-heading">
            ...
            <div class="row mb10">
                ...
                <div class="col-sm-4">
                <div class="form-group">
            	<label class="control-label">Center Number</label>
...
<div class="panel-heading">
            ...
            <div class="row mb10">
				...
				<?php //echo $form->dropDownList($model,'pp_country',array('1'=>'india','2'=>'pakistan'),array('prompt' => 'Select Country','class'=>'form-control mb15')); 
				 ...
				 array(
					...
					'success' => 'function(data){
						$("#Center_pp_province").html(data);
						$("#Center_pp_province").trigger("chosen:updated");
						}',
               ...
               ?>
				...
				<?php 
				$provinces = array();
				if($model->pp_province)
					$provinces = CHtml::listData(Provinces::model()->findAllByAttributes(array('country_id'=>$model->pp_country)), 'id', 'name');
				echo $form->dropDownList($model,'pp_province',$provinces,
				 array(
					...
					'success' => 'function(data){
						$("#Center_pp_city").html(data);
						$("#Center_pp_city").trigger("chosen:updated");
						}',
				...
				echo $form->dropDownList($model,'pp_city',$cities,
				 array(
					...
					'success' => 'function(data){
						$("#Center_pp_suburb").html(data);
						$("#Center_pp_suburb").trigger("chosen:updated");
						}',
            ...
            <div class="row mb10">
				...
				$suburbs = array();
				if($model->pp_suburb)
					$suburbs = CHtml::listData(Suburbs::model()->findAllByAttributes(array('city_id'=>$model->pp_city)), 'id', 'name'); 
				echo $form->dropDownList($model,'pp_suburb',$suburbs,
				 array(
...
<div class="panel-heading">
            ...
            <div class="row mb10">
				...
				<?php //echo $form->dropDownList($model,'pp_country',array('1'=>'india','2'=>'pakistan'),array('prompt' => 'Select Country','class'=>'form-control mb15')); 
               	...
               	echo $form->dropDownList($model,'ph_country',CHtml::listData(Countries::model()->findAllByAttributes(array('is_active'=>1)), 'id', 'name'),
				 array(
					'prompt'=>'Select Country'
					,'class'=>'form-control mb15',
					'ajax' => array(
					...
					'url'=>Yii::app()->createUrl('/center/loadprovinces'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#Center_ph_province").html(data);
						$("#Center_ph_province").trigger("chosen:updated");
						}',
				  'data'=>array('Country'=>'js:this.value'),
				  ))); 
               ?>
				...
				<?php 
				$provinces = array();
				if($model->po_province)
					$provinces = CHtml::listData(Provinces::model()->findAllByAttributes(array('country_id'=>$model->ph_country)), 'id', 'name');
				echo $form->dropDownList($model,'ph_province',$provinces,
				 array(
					'prompt'=>'Select Province'
					,'class'=>'form-control mb15',
					'ajax' => array(
					...
					'url'=>Yii::app()->createUrl('/center/loadcities'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#Center_ph_city").html(data);
						$("#Center_ph_city").trigger("chosen:updated");
						}',
				  'data'=>array('Province'=>'js:this.value'),
				  ))); 
				//echo $form->dropDownList($model,'pp_province',array('1'=>'kochi','2'=>'alappuzha'),array('prompt' => 'Select Province','class'=>'form-control mb15')); ?>
				...
				$cities = array();
				if($model->ph_city)
					$cities = CHtml::listData(Cities::model()->findAllByAttributes(array('province_id'=>$model->ph_province)), 'id', 'name');
				echo $form->dropDownList($model,'ph_city',$cities,
				 array(
					'prompt'=>'Select Cities'
					,'class'=>'form-control mb15',
					'ajax' => array(
					...
					'url'=>Yii::app()->createUrl('/center/loadsuburbs'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#Center_ph_suburb").html(data);
						$("#Center_ph_suburb").trigger("chosen:updated");
						}',
				  'data'=>array('City'=>'js:this.value'),
				  ))); 
				//echo $form->dropDownList($model,'pp_city',array('1'=>'kochi','2'=>'alappuzha'),array('prompt' => 'Select City','class'=>'form-control mb15')); ?>
            ...
            <div class="row mb10">
				...
				$suburbs = array();
				if($model->po_suburb)
					$suburbs = CHtml::listData(Suburbs::model()->findAllByAttributes(array('city_id'=>$model->ph_city)), 'id', 'name');  
				echo $form->dropDownList($model,'ph_suburb',$suburbs,
				 array(
					'prompt'=>'Select Suburb'
					,'class'=>'form-control mb15',
					)); 
...
<div class="panel-heading">
            ...
            <div class="row mb10">
				...
				<?php //echo $form->dropDownList($model,'pp_country',array('1'=>'india','2'=>'pakistan'),array('prompt' => 'Select Country','class'=>'form-control mb15')); 
				 ...
				 array(
					...
					'url'=>Yii::app()->createUrl('/center/loadprovinces'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#Center_po_province").html(data);
						$("#Center_po_province").trigger("chosen:updated");
						}',
				  'data'=>array('Country'=>'js:this.value'),
				  ))); 
               ?>
				...
				$provinces = array();
				if($model->po_province)
					$provinces = CHtml::listData(Provinces::model()->findAllByAttributes(array('country_id'=>$model->po_country)), 'id', 'name');
				echo $form->dropDownList($model,'po_province',$provinces,
				 array(
					'prompt'=>'Select Province'
					,'class'=>'form-control mb15',
					'ajax' => array(
					...
					'url'=>Yii::app()->createUrl('/center/loadcities'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#Center_po_city").html(data);
						$("#Center_po_city").trigger("chosen:updated");
						}',
				  'data'=>array('Province'=>'js:this.value'),
				  ))); 
				//echo $form->dropDownList($model,'pp_province',array('1'=>'kochi','2'=>'alappuzha'),array('prompt' => 'Select Province','class'=>'form-control mb15')); ?>
				...
				echo $form->dropDownList($model,'po_city',$cities,
				 array(
					...
					'url'=>Yii::app()->createUrl('/center/loadsuburbs'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#Center_po_suburb").html(data);
						$("#Center_po_suburb").trigger("chosen:updated");
						}',
				  'data'=>array('City'=>'js:this.value'),
				  ))); 
				//echo $form->dropDownList($model,'pp_city',array('1'=>'kochi','2'=>'alappuzha'),array('prompt' => 'Select City','class'=>'form-control mb15')); ?>
            ...
            <div class="row mb10">
				...
				$suburbs = array();
				if($model->po_suburb)
					$suburbs = CHtml::listData(Suburbs::model()->findAllByAttributes(array('city_id'=>$model->po_city)), 'id', 'name');  
				echo $form->dropDownList($model,'po_suburb',$suburbs,
				 array(
					'prompt'=>'Select Suburb'
					,'class'=>'form-control mb15',
					)); 
...
<div class="panel-heading">
		...
		?>
                ...
                <div class="form-group">
                <label class="control-label"> Registered with the SACE</label><br />
...
<div class="panel-heading">
		...
		<?php echo $form->error($model,'achievements'); ?>
          ...
          <label class="control-label">Do you have a criminal record?</label><br />
			<?php echo $form->radioButtonList($model, 'is_criminal', array('1'=>'Yes', '0'=>'No'), array('uncheckValue'=>null, 'onclick'=>"",'separator' =>'' )); ?>
  ...
  <!--Map-->       
	...
	<div class="panel-heading">
          ...
          <div class="panel-body">
				<?php echo $form->hiddenField($model,'location_lat',array('id'=>'location_lat')); ?>
                <?php echo $form->hiddenField($model,'location_long',array('id'=>'location_long')); ?>
