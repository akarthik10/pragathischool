...
<?php $center = Center::model()->findByAttributes(array('id'=>$center_id)) ;?>

<div class="pageheader">
  <h2><i class="fa fa-user"></i> Create Center </h2>
...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
            ...
            <tbody>
              ...
              <tr>
                <td width="30%">Support Center Name :</td>
              ...
              <div class="col-lg-3">
                <div style=" padding-left:20px;">
                 ...
                 <?php 
						...
						CHtml::normalizeUrl(array('/center/ajaxedit')),
			...
			<?php 
						...
						CHtml::normalizeUrl(array('/center/ajaxdelete')),
						 array('dataType'=>'json', 'type'=>'post','success'=>'js: function(data) {
							if (data.status == "error")
							{
              ...
              <div class="col-lg-3">
                <div style=" padding-left:20px;">
                  <?php 
						...
						CHtml::normalizeUrl(array('/center/ajaxcreate')),
						 array('dataType'=>'json', 'type'=>'post','success'=>'js: function(data) {
							if (data.status == "error")
							{	$(".errorMessage").remove();
  ...
  <div class="panel-footer">
    <?php $location = CenterLocation::model()->findByAttributes(array('center_id'=>$_REQUEST['id']));
	if(isset($location) and $location != NULL)
	{
		
		echo CHtml::Link('Continue',array('center/view','id'=>$_REQUEST['id']),array('class'=>'btn btn-orange'));
	}
	else
	{
		echo CHtml::Link('Continue',array('centerLocation/create','id'=>$_REQUEST['id']),array('class'=>'btn btn-orange'));
	}
