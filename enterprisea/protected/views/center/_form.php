  ...
  <div class="panel-body">
    <div class="row mb10">
      <div class="col-sm-6">
        ...
        <?php 
			$i = 1;
			$defaults = Services::model()->findAllByAttributes(array('is_editable'=>1));
      ...
      <div class="col-sm-4">
        <div class="form-group">
          ...
          <?php 
				...
				echo $form->dropDownList($model_service,'service_id',$services,array('options' =>$options,'multiple'=>true,'class'=>'form-control mb15')); ?>
...
<div class="panel-heading">
            ...
            <div class="row mb10">
               ...
               ?>
				...
				echo $form->dropDownList($model,'ph_province',array(),
				 array(
					'prompt'=>'Select Province'
					,'class'=>'form-control mb15',
					'ajax' => array(
            ...
            <div class="row mb10">
				...
				<?php 
				echo $form->dropDownList($model,'ph_suburb',array(),
				 array(
					'prompt'=>'Select Suburb'
					,'class'=>'form-control mb15',
					)); 
