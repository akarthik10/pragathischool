<div class="pageheader">
      <h2><i class="glyphicon glyphicon-bookmark"></i> Private Tutor</h2>
...
<div class="panel panel-default">
	<div class="panel-heading" style="position:relative;">
		...
		<?php echo CHtml::link('Create Private Tutor',array('/privateTutor/create'),array('class'=>'btn btn-success')); ?></div>
