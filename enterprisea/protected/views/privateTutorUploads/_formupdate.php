...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'action'=>CController::createUrl('privateTutorUploads/update',array('document_id'=>$model->id))
)); ?>
<div class="panel panel-default">
	<div class="panel-heading" style="position:relative;">
    	
        <div class="col-sm-8"><h3 class="panel-title">Document Name</h3></div>
        <div class="col-sm-4">
        	 <?php echo CHtml::link('Document List', array('privateTutorUploads/create', 'id'=>$center_id),array('class'=>' btn btn-success pull-right')); ?>
        </div>
    ...
    <div class="formCon" style="clear:left;">
        <div class="formConInner" id="innerDiv">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="documentTable">
            	<tr>
                	<td width="40%"><?php echo $form->labelEx($model,'Document Name'); ?></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td id="existing_file">
                        ...
                        <div class="btn-demo" style="margin:10px 10px 5px;">
                        	 <?php echo CHtml::link('<span>'.Yii::t('students','View').'</span>', array('privateTutorUploads/download','id'=>$model->id,'center_id'=>$model->center_id),array('class'=>'btn btn-primary')); ?>
