...
<div class="panel panel-default">
  ...
  <?php $documents = PrivateTutorImages::model()->findAllByAttributes(array('center_id'=>$_REQUEST['id'])); ?>
    <?php
			...
			?>
				...
				<?php echo CHtml::link('Edit', array('privateTutorImages/update','id'=>$document->center_id,'document_id'=>$document->id),array('class'=>''));  ?></span>
                <span class="btn btn-danger">
				<i class="glyphicon glyphicon-trash"></i>
				<?php echo CHtml::link('Delete', array('privateTutorImages/deletes','id'=>$document->center_id,'document_id'=>$document->id),array('class'=>'','confirm'=>'Are you sure?'));  ?></span>
                </div>
                </div>
    <?php }}else{ ?>
