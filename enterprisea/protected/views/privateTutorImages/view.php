    	...
    	<ul class="nav nav-tabs nav-justified">
         <li ><?php echo CHtml::Link('<strong>Tutor <br>Details</strong>',array('privateTutor/view','id'=>$id));?></li>
          ...
          <li><?php echo CHtml::Link('<strong>Upload <br>Documents</strong>',array('privateTutorUploads/view','id'=>$id));?></li>
           <li class="active"><?php echo CHtml::Link('<strong>Upload <br>Images</strong>',array('privateTutorImages/view','id'=>$id));?></li>

        </ul>
      <div class="panel-heading" style="position:relative; height:60px;">
        <div class="btn-demo file_up" style="position:relative; top:-8px; right:3px; float:right;"><?php echo CHtml::Link('Edit Upload Images',array('privateTutorImages/create','id'=>$id),array('class'=>'btn btn-success'));?></div>
