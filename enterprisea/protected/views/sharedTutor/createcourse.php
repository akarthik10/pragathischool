...
<?php $center = SharedTutor::model()->findByAttributes(array('id'=>$center_id)) ;?>

<div class="pageheader">
  <h2><i class="fa fa-user"></i> Create SharedTutor </h2>
...
<div class="contentpanel">
  <div class="col-sm-9 col-lg-12">
      ...
      <div class="panel-body">
        <div class="table-responsive">
            ...
            <tbody>
              ...
              <tr>
                <td width="30%">Shared Tutor  Name :</td>
              ...
              <div class="col-lg-3">
                <div style=" padding-left:20px;">
                  <?php 
						...
						CHtml::normalizeUrl(array('/sharedTutor/ajaxcreate')),
						 array('dataType'=>'json', 'type'=>'post','success'=>'js: function(data) {
							if (data.status == "error")
							{	$(".errorMessage").remove();
    ...
    <?php $location = SharedTutorLocation::model()->findByAttributes(array('center_id'=>$_REQUEST['id']));
	if(isset($location) and $location != NULL)
	{
		
		echo CHtml::Link('Continue',array('sharedTutor/view','id'=>$_REQUEST['id']),array('class'=>'btn btn-primary'));
	}
	else
	{
		echo CHtml::Link('Continue',array('sharedTutorLocation/create','id'=>$_REQUEST['id']),array('class'=>'btn btn-primary'));
	}
