...
<div class="panel-heading" style="position:relative;">
              <div class="clear"></div>
              <h3 class="panel-title">Shared Tutor Registration Application</h3>
  </div>
       ...
       <?php
				...
				echo $form->dropDownList($model,'type_id',$school,
				 array(
					...
					'success'=>'js:function(data){ $("#SharedTutorCourse_course_id").html(data);$("#SharedTutorCourse_course_id").trigger("chosen:updated");}', //or 'success' => 'function(data){...handle the data in the way you want...}',
        ...
        <div class="form-group">
			...
			if(isset($_POST['SharedTutorCourse']['course_id']))
			{
				 foreach ($_POST['SharedTutorCourse']['course_id'] as $optionVal) {
					 if ($optionVal) {
						$options[$optionVal] = array('selected' => 'selected');
						}
					}
			}else
				$saved_courses= SharedTutorCourse::model()->findAllByAttributes(array('center_id'=>$model->id));
				...
				<?php //echo $form->dropDownList($model,'pp_country',array('1'=>'india','2'=>'pakistan'),array('prompt' => 'Select Country','class'=>'form-control mb15')); 
				 ...
				 array(
					...
					'success' => 'function(data){
						$("#SharedTutor_pp_province").html(data);
						$("#SharedTutor_pp_province").trigger("chosen:updated");
						}',
               ...
               ?>
				...
				echo $form->dropDownList($model,'pp_province',$provinces,
				 array(
					...
					'success' => 'function(data){
						$("#SharedTutor_pp_city").html(data);
						$("#SharedTutor_pp_city").trigger("chosen:updated");
						}',
				...
				echo $form->dropDownList($model,'pp_city',$cities,
				 array(
					...
					'success' => 'function(data){
						$("#SharedTutor_pp_suburb").html(data);
						$("#SharedTutor_pp_suburb").trigger("chosen:updated");
						}',
            ...
            <div class="row mb10">
				...
				<?php //echo $form->dropDownList($model,'pp_country',array('1'=>'india','2'=>'pakistan'),array('prompt' => 'Select Country','class'=>'form-control mb15')); 
				 ...
				 array(
					...
					'url'=>Yii::app()->createUrl('/center/loadprovinces'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#SharedTutor_po_province").html(data);
						$("#SharedTutor_po_province").trigger("chosen:updated");
						}',
				  'data'=>array('Country'=>'js:this.value'),
				  ))); 
               ?>
				...
				echo $form->dropDownList($model,'po_province',$provinces,
				 array(
					...
					'url'=>Yii::app()->createUrl('/center/loadcities'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#SharedTutor_po_city").html(data);
						$("#SharedTutor_po_city").trigger("chosen:updated");
						}',
				  'data'=>array('Province'=>'js:this.value'),
				  ))); 
				//echo $form->dropDownList($model,'pp_province',array('1'=>'kochi','2'=>'alappuzha'),array('prompt' => 'Select Province','class'=>'form-control mb15')); ?>
				...
				echo $form->dropDownList($model,'po_city',$cities,
				 array(
					...
					'url'=>Yii::app()->createUrl('/center/loadsuburbs'), //or $this->createUrl('loadcities') if '$this' extends CController
					'success' => 'function(data){
						$("#SharedTutor_po_suburb").html(data);
						$("#SharedTutor_po_suburb").trigger("chosen:updated");
						}',
				  'data'=>array('City'=>'js:this.value'),
				  ))); 
				//echo $form->dropDownList($model,'pp_city',array('1'=>'kochi','2'=>'alappuzha'),array('prompt' => 'Select City','class'=>'form-control mb15')); ?>
...
<div class="panel-heading">
            ...
            <div class="row mb10">
                ...
                <?php echo $form->textField($model_1,'position',array('class'=>'form-control mb15')); ?> <?php echo $form->error($model_1,'position'); ?>	
            ...
            <div class="row mb10">
                ...
                <div class="form-group">
                 ...
                 <?php echo $form->textField($model_1,'period',array('class'=>'form-control mb15')); ?>
                    <?php echo $form->error($model_1,'period'); ?> </div>
                </div>
                <div class="col-sm-4">
...
<div class="panel-heading">
		...
		?>
                ...
                <div class="col-sm-4">
                <div class="form-group">
                 <label class="control-label">Are you registered with the SACE ?</label><br />
...
By clicking submit I Confirm that all the information contained herein is true and correct AND declare that I have read and agree to the TERMS & CONDITIONS of use of any or all StudyPro products and services.</p>
    ...
    <p>Type these numbers and letters in the space provided.</p>
     ...
     <div class="row mb10">
            	<div class="col-sm-4"><?php $this->widget('CCaptcha'); ?><br />
