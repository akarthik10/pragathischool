...
<div class="contentpanel">
  <div class="col-sm-9 col-lg-12">
    <div class="panel panel-default">
        ...
        <li class="active"><?php echo CHtml::Link('<strong>Tutor <br>Details</strong>',array('sharedTutor/view','id'=>$id));?></li>
      ...
      <div class="panel-heading" style="position:relative; height:60px;">
        <div class="btn-demo file_up" style="position:relative; top:-8px; right:3px; float:right;"><?php echo CHtml::Link('Edit Shared Tutor Details',array('update','id'=>$center->id),array('class'=>'btn btn-success'));?></div>
